...
module cputop;
  ...
  task test1;
    begin
      test = 0;
      disable MONITOR;
      $readmemb ("E:/FPGA/CPU/TuringComplete/TuringComplete.srcs/sim_1/new/test1.pro", t_rom.memory );
      $display ("rom loaded successfully!");
      $readmemb ("E:/FPGA/CPU/TuringComplete/TuringComplete.srcs/sim_1/new/test1.dat", t_ram.ram );
  ...
  task test2;
    begin
      test = 0;
      disable MONITOR;
      $readmemb ("E:/FPGA/CPU/TuringComplete/TuringComplete.srcs/sim_1/new/test2.pro", t_rom.memory );
      $display ("rom loaded successfully!");
      $readmemb ("E:/FPGA/CPU/TuringComplete/TuringComplete.srcs/sim_1/new/test2.dat", t_ram.ram );
      $display ("ram loaded successfully!");
      #1 test = 2;
      #11600;
      sys_reset;
  ...
  task test3;
    begin
      test = 0;
      disable MONITOR;
      $readmemb ("E:/FPGA/CPU/TuringComplete/TuringComplete.srcs/sim_1/new/test3.pro", t_rom.memory );
      $display ("rom loaded successfully!");
      $readmemb ("E:/FPGA/CPU/TuringComplete/TuringComplete.srcs/sim_1/new/test3.dat", t_ram.ram );
      $display ("ram loaded successfully!");
      #1 test = 3;
      #94000;
      sys_reset;
...
//            #340 $strobe("%t %h %s %h %h", $time, PC_addr, mnemonic, IR_addr, data ); // Here data has been changed t_cpu.m_register.data
            #340 $display("%t %h %s %h %h", $time, PC_addr, mnemonic, IR_addr, data ); // Here data has been changed t_cpu.m_register.data
...
//          $strobe("%t     %d", $time, t_ram.ram [ 10'h2 ]);
          $display("%t     %d", $time, t_ram.ram [ 10'h2 ]);
